...
_get_pid:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  12:	83 ec 04             	sub    $0x4,%esp
    printf(1, "%d\n", getpid());
  15:	e8 f9 02 00 00       	call   313 <getpid>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb 9c 07 00 00       	mov    $0x79c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 605:	a1 4c 0a 00 00       	mov    0xa4c,%eax
{
 ...
 626:	73 10                	jae    638 <free+0x38>
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	a3 4c 0a 00 00       	mov    %eax,0xa4c
}
 657:	5e                   	pop    %esi
 658:	5f                   	pop    %edi
 659:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 69d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6a0:	8b 3d 4c 0a 00 00    	mov    0xa4c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e9:	8b 3d 4c 0a 00 00    	mov    0xa4c,%edi
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
  return freep;
 717:	a1 4c 0a 00 00       	mov    0xa4c,%eax
 ...
 744:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 747:	a3 4c 0a 00 00       	mov    %eax,0xa4c
}
 ...
 75e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 4c 0a 00 00 50 	movl   $0xa50,0xa4c
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf 50 0a 00 00       	mov    $0xa50,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 50 0a 00 00 50 	movl   $0xa50,0xa50
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 77b:	c7 05 54 0a 00 00 00 	movl   $0x0,0xa54
 782:	00 00 00 
    if(p->s.size >= nunits){
