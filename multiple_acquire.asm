...
_multiple_acquire:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  printf(1, "Calling acquire() %d times\n", cnt);
  27:	68 a8 07 00 00       	push   $0x7a8
  2c:	6a 01                	push   $0x1
  2e:	e8 0d 04 00 00       	call   440 <printf>
  multiple_acquire(cnt);
  33:	89 1c 24             	mov    %ebx,(%esp)
  36:	e8 40 03 00 00       	call   37b <multiple_acquire>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb c4 07 00 00       	mov    $0x7c4,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 615:	a1 78 0a 00 00       	mov    0xa78,%eax
{
...
malloc(uint nbytes)
{
 ...
 6ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6b0:	8b 3d 78 0a 00 00    	mov    0xa78,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
