...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	eb 1a                	jmp    6b0 <printf+0x1a0>
          s = "(null)";
 696:	bb b0 08 00 00       	mov    $0x8b0,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e5:	a1 a0 0b 00 00       	mov    0xba0,%eax
{
 ...
 706:	73 10                	jae    718 <free+0x38>
{
 ...
 731:	5b                   	pop    %ebx
  freep = p;
 732:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 737:	5e                   	pop    %esi
 738:	5f                   	pop    %edi
 739:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 77d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 780:	8b 3d a0 0b 00 00    	mov    0xba0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7c9:	8b 3d a0 0b 00 00    	mov    0xba0,%edi
 ...
 7f2:	e8 e9 fe ff ff       	call   6e0 <free>
  return freep;
 7f7:	a1 a0 0b 00 00       	mov    0xba0,%eax
 ...
 824:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 827:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 ...
 847:	0b 00 00 
    base.s.size = 0;
 84a:	bf a4 0b 00 00       	mov    $0xba4,%edi
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 a4 0b 00 00 a4 	movl   $0xba4,0xba4
 856:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 859:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 85b:	c7 05 a8 0b 00 00 00 	movl   $0x0,0xba8
 862:	00 00 00 
    if(p->s.size >= nunits){
