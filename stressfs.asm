  ...
  1f:	31 db                	xor    %ebx,%ebx
{
  ...
  8a:	6a 01                	push   $0x1
  8c:	e8 af 04 00 00       	call   540 <printf>
  path[8] += i;
...
free(void *ap)
{
 ...
 715:	a1 8c 0b 00 00       	mov    0xb8c,%eax
{
...
malloc(uint nbytes)
{
 ...
 7ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7b0:	8b 3d 8c 0b 00 00    	mov    0xb8c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 822:	e8 e9 fe ff ff       	call   710 <free>
  return freep;
 827:	a1 8c 0b 00 00       	mov    0xb8c,%eax
 ...
 854:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 857:	a3 8c 0b 00 00       	mov    %eax,0xb8c
}
