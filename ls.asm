...
0000066b <sem_acquire>:
SYSCALL(sem_acquire)
 66b:	b8 1b 00 00 00       	mov    $0x1b,%eax
 670:	cd 40                	int    $0x40
 672:	c3                   	ret    

00000673 <sem_release>:
SYSCALL(sem_release)
 673:	b8 1c 00 00 00       	mov    $0x1c,%eax
 678:	cd 40                	int    $0x40
 67a:	c3                   	ret    

0000067b <multiple_acquire>:
 ...
 69c:	89 d1                	mov    %edx,%ecx
{
 ...
 6c9:	0f b6 92 fc 0a 00 00 	movzbl 0xafc(%edx),%edx
 ...
 70e:	56                   	push   %esi
 70f:	57                   	push   %edi
 710:	e8 ae fe ff ff       	call   5c3 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 789:	e8 35 fe ff ff       	call   5c3 <write>
 ...
 7e9:	e8 d5 fd ff ff       	call   5c3 <write>
        putc(fd, c);
      } else {
 ...
 7fd:	e8 c1 fd ff ff       	call   5c3 <write>
  for(i = 0; fmt[i]; i++){
 ...
 871:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 874:	e8 4a fd ff ff       	call   5c3 <write>
        ap++;
 ...
 8c4:	eb 1a                	jmp    8e0 <printf+0x1a0>
          s = "(null)";
 8c6:	bb f2 0a 00 00       	mov    $0xaf2,%ebx
        while(*s != 0){
 ...
 8eb:	57                   	push   %edi
 8ec:	53                   	push   %ebx
 8ed:	e8 d1 fc ff ff       	call   5c3 <write>
        while(*s != 0){
 ...
 936:	73 10                	jae    948 <free+0x38>
{
 ...
 961:	5b                   	pop    %ebx
  freep = p;
 962:	a3 34 0e 00 00       	mov    %eax,0xe34
}
 967:	5e                   	pop    %esi
 968:	5f                   	pop    %edi
 969:	5d                   	pop    %ebp
 ...
 987:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 98a:	a3 34 0e 00 00       	mov    %eax,0xe34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9b0:	8b 3d 34 0e 00 00    	mov    0xe34,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9f9:	8b 3d 34 0e 00 00    	mov    0xe34,%edi
 ...
 a0b:	e8 1b fc ff ff       	call   62b <sbrk>
  if(p == (char*)-1)
 ...
 a22:	e8 e9 fe ff ff       	call   910 <free>
  return freep;
 a27:	a1 34 0e 00 00       	mov    0xe34,%eax
 ...
 a54:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 a57:	a3 34 0e 00 00       	mov    %eax,0xe34
}
 ...
 a6e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 a70:	c7 05 34 0e 00 00 38 	movl   $0xe38,0xe34
 a77:	0e 00 00 
    base.s.size = 0;
 a7a:	bf 38 0e 00 00       	mov    $0xe38,%edi
    base.s.ptr = freep = prevp = &base;
 a7f:	c7 05 38 0e 00 00 38 	movl   $0xe38,0xe38
 a86:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a89:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 a8b:	c7 05 3c 0e 00 00 00 	movl   $0x0,0xe3c
 a92:	00 00 00 
    if(p->s.size >= nunits){
