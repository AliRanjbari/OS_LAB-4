...
int main()
{
  ...
  6f:	50                   	push   %eax
  70:	68 88 08 00 00       	push   $0x888
  75:	6a 01                	push   $0x1
  77:	e8 84 04 00 00       	call   500 <printf>
  ...
  9f:	50                   	push   %eax
  a0:	68 de 08 00 00       	push   $0x8de
  a5:	6a 01                	push   $0x1
  a7:	e8 54 04 00 00       	call   500 <printf>
 ...
 10a:	50                   	push   %eax
 10b:	68 bf 08 00 00       	push   $0x8bf
 110:	6a 01                	push   $0x1
 112:	e8 e9 03 00 00       	call   500 <printf>
...
printf(int fd, const char *fmt, ...)
{
 ...
 549:	e8 55 fe ff ff       	call   3a3 <write>
 ...
 5a9:	e8 f5 fd ff ff       	call   3a3 <write>
        putc(fd, c);
      } else {
 ...
 631:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 634:	e8 6a fd ff ff       	call   3a3 <write>
        ap++;
 ...
 684:	eb 1a                	jmp    6a0 <printf+0x1a0>
          s = "(null)";
 686:	bb 0d 09 00 00       	mov    $0x90d,%ebx
        while(*s != 0){
 ...
 6ab:	57                   	push   %edi
 6ac:	53                   	push   %ebx
 6ad:	e8 f1 fc ff ff       	call   3a3 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d5:	a1 bc 0b 00 00       	mov    0xbbc,%eax
{
 ...
 6f6:	73 10                	jae    708 <free+0x38>
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	a3 bc 0b 00 00       	mov    %eax,0xbbc
}
 727:	5e                   	pop    %esi
 728:	5f                   	pop    %edi
 729:	5d                   	pop    %ebp
 ...
 747:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 74a:	a3 bc 0b 00 00       	mov    %eax,0xbbc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 76d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 770:	8b 3d bc 0b 00 00    	mov    0xbbc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7b9:	8b 3d bc 0b 00 00    	mov    0xbbc,%edi
 ...
 7cb:	e8 3b fc ff ff       	call   40b <sbrk>
  if(p == (char*)-1)
 ...
 7e2:	e8 e9 fe ff ff       	call   6d0 <free>
  return freep;
 7e7:	a1 bc 0b 00 00       	mov    0xbbc,%eax
 ...
 814:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 817:	a3 bc 0b 00 00       	mov    %eax,0xbbc
}
