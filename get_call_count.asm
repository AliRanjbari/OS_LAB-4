...
int main()
{
  ...
  12:	83 ec 04             	sub    $0x4,%esp
    ...
    int child1 = fork();
  15:	e8 61 03 00 00       	call   37b <fork>
    if(child1 != 0) {
  1a:	85 c0                	test   %eax,%eax
  1c:	74 63                	je     81 <main+0x81>
        wait();
  1e:	e8 68 03 00 00       	call   38b <wait>
        int child2 = fork();
  23:	e8 53 03 00 00       	call   37b <fork>
        if(child2 != 0) {
  28:	85 c0                	test   %eax,%eax
  2a:	0f 84 a0 00 00 00    	je     d0 <main+0xd0>
            wait();
  30:	e8 56 03 00 00       	call   38b <wait>
            write(1, "parent\n", 7);
  35:	51                   	push   %ecx
  36:	6a 07                	push   $0x7
  38:	68 88 08 00 00       	push   $0x888
  3d:	6a 01                	push   $0x1
  3f:	e8 5f 03 00 00       	call   3a3 <write>
            printf(1, "parent write count: %d\n", get_call_count(SYS_write));
  44:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
  4b:	e8 db 03 00 00       	call   42b <get_call_count>
  50:	83 c4 0c             	add    $0xc,%esp
  53:	50                   	push   %eax
  54:	68 90 08 00 00       	push   $0x890
  59:	6a 01                	push   $0x1
  5b:	e8 c0 04 00 00       	call   520 <printf>
            printf(1, "parent fork count: %d\n", get_call_count(SYS_fork));
  60:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  67:	e8 bf 03 00 00       	call   42b <get_call_count>
  6c:	83 c4 0c             	add    $0xc,%esp
  6f:	50                   	push   %eax
  70:	68 a8 08 00 00       	push   $0x8a8
  75:	6a 01                	push   $0x1
  77:	e8 a4 04 00 00       	call   520 <printf>
  7c:	83 c4 10             	add    $0x10,%esp
  7f:	eb 4a                	jmp    cb <main+0xcb>
  ...
  81:	50                   	push   %eax
  82:	6a 07                	push   $0x7
  84:	68 f6 08 00 00       	push   $0x8f6
  89:	6a 01                	push   $0x1
  8b:	e8 13 03 00 00       	call   3a3 <write>
        printf(1, "child1 write count: %d\n", get_call_count(SYS_write));
  90:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
  97:	e8 8f 03 00 00       	call   42b <get_call_count>
  9c:	83 c4 0c             	add    $0xc,%esp
  9f:	50                   	push   %eax
  a0:	68 fe 08 00 00       	push   $0x8fe
  a5:	6a 01                	push   $0x1
  a7:	e8 74 04 00 00       	call   520 <printf>
        printf(1, "child1 fork count: %d\n", get_call_count(SYS_fork));
  ac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  b3:	e8 73 03 00 00       	call   42b <get_call_count>
  b8:	83 c4 0c             	add    $0xc,%esp
  bb:	50                   	push   %eax
  bc:	68 16 09 00 00       	push   $0x916
  c1:	6a 01                	push   $0x1
  c3:	e8 58 04 00 00       	call   520 <printf>
  c8:	83 c4 10             	add    $0x10,%esp
    }

    exit();
  cb:	e8 b3 02 00 00       	call   383 <exit>
            write(1, "child2\n", 7);
  d0:	52                   	push   %edx
  d1:	6a 07                	push   $0x7
  d3:	68 bf 08 00 00       	push   $0x8bf
  d8:	6a 01                	push   $0x1
  da:	e8 c4 02 00 00       	call   3a3 <write>
            printf(1, "child2 write count: %d\n", get_call_count(SYS_write));
  df:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
  e6:	e8 40 03 00 00       	call   42b <get_call_count>
  eb:	83 c4 0c             	add    $0xc,%esp
  ee:	50                   	push   %eax
  ef:	68 c7 08 00 00       	push   $0x8c7
  f4:	6a 01                	push   $0x1
  f6:	e8 25 04 00 00       	call   520 <printf>
            printf(1, "child2 fork count: %d\n", get_call_count(SYS_fork));
  fb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 102:	e8 24 03 00 00       	call   42b <get_call_count>
 107:	83 c4 0c             	add    $0xc,%esp
 10a:	50                   	push   %eax
 10b:	68 df 08 00 00       	push   $0x8df
 110:	6a 01                	push   $0x1
 112:	e8 09 04 00 00       	call   520 <printf>
 117:	83 c4 10             	add    $0x10,%esp
 11a:	eb af                	jmp    cb <main+0xcb>
 ...
 47c:	89 d1                	mov    %edx,%ecx
{
 ...
 4a9:	0f b6 92 34 09 00 00 	movzbl 0x934(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	eb 1a                	jmp    6c0 <printf+0x1a0>
          s = "(null)";
 6a6:	bb 2d 09 00 00       	mov    $0x92d,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f5:	a1 dc 0b 00 00       	mov    0xbdc,%eax
{
 ...
 716:	73 10                	jae    728 <free+0x38>
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	a3 dc 0b 00 00       	mov    %eax,0xbdc
}
 747:	5e                   	pop    %esi
 748:	5f                   	pop    %edi
 749:	5d                   	pop    %ebp
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 dc 0b 00 00       	mov    %eax,0xbdc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 78d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 790:	8b 3d dc 0b 00 00    	mov    0xbdc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d9:	8b 3d dc 0b 00 00    	mov    0xbdc,%edi
 ...
 802:	e8 e9 fe ff ff       	call   6f0 <free>
  return freep;
 807:	a1 dc 0b 00 00       	mov    0xbdc,%eax
 ...
 834:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 837:	a3 dc 0b 00 00       	mov    %eax,0xbdc
}
 ...
 84e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 dc 0b 00 00 e0 	movl   $0xbe0,0xbdc
 857:	0b 00 00 
    base.s.size = 0;
 85a:	bf e0 0b 00 00       	mov    $0xbe0,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 e0 0b 00 00 e0 	movl   $0xbe0,0xbe0
 866:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 86b:	c7 05 e4 0b 00 00 00 	movl   $0x0,0xbe4
 872:	00 00 00 
    if(p->s.size >= nunits){
