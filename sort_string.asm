...
main(int argc, char *argv[]){
  ...
  22:	6a 01                	push   $0x1
  24:	e8 62 03 00 00       	call   38b <close>
        int fd = open("sort_string.txt", O_CREATE|O_WRONLY);      
  29:	58                   	pop    %eax
  2a:	5a                   	pop    %edx
  2b:	68 01 02 00 00       	push   $0x201
  30:	68 7f 08 00 00       	push   $0x87f
  35:	e8 69 03 00 00       	call   3a3 <open>
  ...
  3d:	58                   	pop    %eax
  3e:	53                   	push   %ebx
  3f:	ff 76 04             	pushl  0x4(%esi)
  42:	e8 29 00 00 00       	call   70 <sort_string>
        close(fd);
  47:	89 1c 24             	mov    %ebx,(%esp)
  4a:	e8 3c 03 00 00       	call   38b <close>
  4f:	83 c4 10             	add    $0x10,%esp
    }
    exit();
  52:	e8 0c 03 00 00       	call   363 <exit>
        printf(1, "please enter a string\n");
  57:	50                   	push   %eax
  58:	50                   	push   %eax
  ...
  68:	eb e8                	jmp    52 <main+0x52>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax

00000070 <sort_string>:
sort_string(char* string, int fd){
  ...
  78:	56                   	push   %esi
  79:	53                   	push   %ebx
  7a:	83 ec 28             	sub    $0x28,%esp
  7d:	8b 75 08             	mov    0x8(%ebp),%esi
    int length = strlen(string);
  80:	56                   	push   %esi
  81:	89 f3                	mov    %esi,%ebx
  83:	e8 f8 00 00 00       	call   180 <strlen>
    for(int i=0; i<length; i++)
  88:	83 c4 10             	add    $0x10,%esp
    int length = strlen(string);
  8b:	89 c7                	mov    %eax,%edi
    for(int i=0; i<length; i++)
  8d:	01 f0                	add    %esi,%eax
  8f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  92:	85 ff                	test   %edi,%edi
  94:	7e 31                	jle    c7 <sort_string+0x57>
  96:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  9d:	8d 76 00             	lea    0x0(%esi),%esi
  a0:	89 d8                	mov    %ebx,%eax
  a2:	29 f0                	sub    %esi,%eax
  a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
            if(string[i] > string[j]){
  a8:	0f b6 13             	movzbl (%ebx),%edx
  ab:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
  af:	38 ca                	cmp    %cl,%dl
  b1:	7e 05                	jle    b8 <sort_string+0x48>
                string[i] = string[j];
  b3:	88 0b                	mov    %cl,(%ebx)
                string[j] = temp;
  b5:	88 14 06             	mov    %dl,(%esi,%eax,1)
        for(int j=i; j<length; j++)
  b8:	83 c0 01             	add    $0x1,%eax
  bb:	39 c7                	cmp    %eax,%edi
  bd:	7f e9                	jg     a8 <sort_string+0x38>
    for(int i=0; i<length; i++)
  bf:	83 c3 01             	add    $0x1,%ebx
  c2:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
  c5:	75 d9                	jne    a0 <sort_string+0x30>
    write(fd, string, strlen(string));
  c7:	83 ec 0c             	sub    $0xc,%esp
  ca:	56                   	push   %esi
  cb:	e8 b0 00 00 00       	call   180 <strlen>
  d0:	83 c4 0c             	add    $0xc,%esp
  d3:	50                   	push   %eax
  d4:	56                   	push   %esi
  d5:	ff 75 0c             	pushl  0xc(%ebp)
  d8:	e8 a6 02 00 00       	call   383 <write>
    write(fd, "\n", 1);
  dd:	83 c4 0c             	add    $0xc,%esp
  e0:	6a 01                	push   $0x1
  e2:	68 7d 08 00 00       	push   $0x87d
...
0000042b <sem_acquire>:
SYSCALL(sem_acquire)
 42b:	b8 1b 00 00 00       	mov    $0x1b,%eax
 430:	cd 40                	int    $0x40
 432:	c3                   	ret    

00000433 <sem_release>:
SYSCALL(sem_release)
 433:	b8 1c 00 00 00       	mov    $0x1c,%eax
 438:	cd 40                	int    $0x40
 43a:	c3                   	ret    

0000043b <multiple_acquire>:
 ...
 45c:	89 d1                	mov    %edx,%ecx
{
 ...
 489:	0f b6 92 98 08 00 00 	movzbl 0x898(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	eb 1a                	jmp    6a0 <printf+0x1a0>
          s = "(null)";
 686:	bb 8f 08 00 00       	mov    $0x88f,%ebx
        while(*s != 0){
