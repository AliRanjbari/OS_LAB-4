...
_find_next_prime_num:     file format elf32-i386
...
int main(int argc, char * argv[]) {
  ...
  12:	53                   	push   %ebx
  13:	51                   	push   %ecx
  14:	81 ec 0c 04 00 00    	sub    $0x40c,%esp
    char buff[1024];
    int a, tempEBX;
    if(argc < 2) {
...
int main(int argc, char * argv[]) {
  ...
  25:	ff 70 04             	pushl  0x4(%eax)
  28:	e8 63 02 00 00       	call   290 <atoi>
  2d:	83 c4 10             	add    $0x10,%esp
  30:	89 c3                	mov    %eax,%ebx
    }
    asm volatile(
  32:	89 de                	mov    %ebx,%esi
  34:	89 db                	mov    %ebx,%ebx
  ...
  48:	e8 56 03 00 00       	call   3a3 <find_next_prime_num>
  4d:	83 c4 0c             	add    $0xc,%esp
  50:	50                   	push   %eax
  51:	68 fb 07 00 00       	push   $0x7fb
  56:	6a 01                	push   $0x1
  58:	e8 23 04 00 00       	call   480 <printf>
	asm("movl %0, %%ebx" : : "r"(tempEBX)); // ebx = saved_ebx -> restore
  5d:	89 f3                	mov    %esi,%ebx
	exit();
  5f:	e8 9f 02 00 00       	call   303 <exit>
        printf(1, "enter an integer:\n");
  64:	50                   	push   %eax
        read(0, buff, 1024);
  65:	8d 9d e8 fb ff ff    	lea    -0x418(%ebp),%ebx
        printf(1, "enter an integer:\n");
  6b:	50                   	push   %eax
  6c:	68 e8 07 00 00       	push   $0x7e8
  71:	6a 01                	push   $0x1
  73:	e8 08 04 00 00       	call   480 <printf>
        read(0, buff, 1024);
  78:	83 c4 0c             	add    $0xc,%esp
  7b:	68 00 04 00 00       	push   $0x400
  80:	53                   	push   %ebx
  81:	6a 00                	push   $0x0
  83:	e8 93 02 00 00       	call   31b <read>
        a = atoi(buff);
  88:	89 1c 24             	mov    %ebx,(%esp)
  8b:	e8 00 02 00 00       	call   290 <atoi>
  90:	83 c4 10             	add    $0x10,%esp
  93:	89 c3                	mov    %eax,%ebx
  95:	eb 9b                	jmp    32 <main+0x32>
  97:	66 90                	xchg   %ax,%ax
  99:	66 90                	xchg   %ax,%ax
  9b:	66 90                	xchg   %ax,%ax
  9d:	66 90                	xchg   %ax,%ax
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 44 08 00 00 	movzbl 0x844(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	eb 1a                	jmp    620 <printf+0x1a0>
          s = "(null)";
 606:	bb 3b 08 00 00       	mov    $0x83b,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 655:	a1 f4 0a 00 00       	mov    0xaf4,%eax
{
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 f4 0a 00 00       	mov    %eax,0xaf4
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 f4 0a 00 00       	mov    %eax,0xaf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6f0:	8b 3d f4 0a 00 00    	mov    0xaf4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
