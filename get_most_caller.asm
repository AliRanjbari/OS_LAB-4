...
int main()
{
  ...
  12:	bb e8 03 00 00       	mov    $0x3e8,%ebx
{
  17:	51                   	push   %ecx
    printf(1, "process id: %d\n", getpid());
  ...
  33:	6a 01                	push   $0x1
  35:	68 18 08 00 00       	push   $0x818
  3a:	6a 01                	push   $0x1
  3c:	e8 02 03 00 00       	call   343 <write>
    for(int i=0; i<1000; i++)
  41:	83 c4 10             	add    $0x10,%esp
  44:	83 eb 01             	sub    $0x1,%ebx
  ...
  4c:	6a 01                	push   $0x1
  4e:	68 16 08 00 00       	push   $0x816
  53:	6a 01                	push   $0x1
  55:	e8 e9 02 00 00       	call   343 <write>
    

    printf(1, "most write caller: %d\n", get_most_caller(SYS_write));
  5a:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
  61:	e8 6d 03 00 00       	call   3d3 <get_most_caller>
  66:	83 c4 0c             	add    $0xc,%esp
  69:	50                   	push   %eax
  6a:	68 1a 08 00 00       	push   $0x81a
  6f:	6a 01                	push   $0x1
  71:	e8 2a 04 00 00       	call   4a0 <printf>
    printf(1, "most wait caller: %d\n", get_most_caller(SYS_wait));
  76:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
  7d:	e8 51 03 00 00       	call   3d3 <get_most_caller>
  82:	83 c4 0c             	add    $0xc,%esp
  85:	50                   	push   %eax
  86:	68 31 08 00 00       	push   $0x831
  8b:	6a 01                	push   $0x1
  8d:	e8 0e 04 00 00       	call   4a0 <printf>
    printf(1, "most fork caller: %d\n", get_most_caller(SYS_fork));
  92:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  99:	e8 35 03 00 00       	call   3d3 <get_most_caller>
  9e:	83 c4 0c             	add    $0xc,%esp
  a1:	50                   	push   %eax
  a2:	68 47 08 00 00       	push   $0x847
  a7:	6a 01                	push   $0x1
  a9:	e8 f2 03 00 00       	call   4a0 <printf>

    exit();
  ae:	e8 70 02 00 00       	call   323 <exit>
  b3:	66 90                	xchg   %ax,%ax
  b5:	66 90                	xchg   %ax,%ax
  b7:	66 90                	xchg   %ax,%ax
  b9:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb 5d 08 00 00       	mov    $0x85d,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 675:	a1 10 0b 00 00       	mov    0xb10,%eax
{
 ...
 696:	73 10                	jae    6a8 <free+0x38>
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	a3 10 0b 00 00       	mov    %eax,0xb10
}
 6c7:	5e                   	pop    %esi
 6c8:	5f                   	pop    %edi
 6c9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 70d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 710:	8b 3d 10 0b 00 00    	mov    0xb10,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 759:	8b 3d 10 0b 00 00    	mov    0xb10,%edi
 ...
 782:	e8 e9 fe ff ff       	call   670 <free>
  return freep;
 787:	a1 10 0b 00 00       	mov    0xb10,%eax
 ...
 7b4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7b7:	a3 10 0b 00 00       	mov    %eax,0xb10
}
 ...
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf 14 0b 00 00       	mov    $0xb14,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 14 0b 00 00 14 	movl   $0xb14,0xb14
 7e6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7eb:	c7 05 18 0b 00 00 00 	movl   $0x0,0xb18
 7f2:	00 00 00 
    if(p->s.size >= nunits){
