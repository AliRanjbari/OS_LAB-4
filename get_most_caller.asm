  ...
  12:	bb e8 03 00 00       	mov    $0x3e8,%ebx
{
  ...
  20:	50                   	push   %eax
  21:	68 28 08 00 00       	push   $0x828
  26:	6a 01                	push   $0x1
  28:	e8 93 04 00 00       	call   4c0 <printf>
  ...
  69:	50                   	push   %eax
  6a:	68 3a 08 00 00       	push   $0x83a
  6f:	6a 01                	push   $0x1
  71:	e8 4a 04 00 00       	call   4c0 <printf>
...
000003eb <sem_acquire>:
SYSCALL(sem_acquire)
 3eb:	b8 1b 00 00 00       	mov    $0x1b,%eax
 3f0:	cd 40                	int    $0x40
 3f2:	c3                   	ret    

000003f3 <sem_release>:
SYSCALL(sem_release)
 3f3:	b8 1c 00 00 00       	mov    $0x1c,%eax
 3f8:	cd 40                	int    $0x40
 3fa:	c3                   	ret    

000003fb <multiple_acquire>:
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb 7d 08 00 00       	mov    $0x87d,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 695:	a1 30 0b 00 00       	mov    0xb30,%eax
{
 ...
 6b6:	73 10                	jae    6c8 <free+0x38>
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	a3 30 0b 00 00       	mov    %eax,0xb30
}
 6e7:	5e                   	pop    %esi
 6e8:	5f                   	pop    %edi
 6e9:	5d                   	pop    %ebp
 ...
 707:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 70a:	a3 30 0b 00 00       	mov    %eax,0xb30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 72d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 730:	8b 3d 30 0b 00 00    	mov    0xb30,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
