...
free(void *ap)
{
 ...
 655:	a1 dc 0a 00 00       	mov    0xadc,%eax
{
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 dc 0a 00 00       	mov    %eax,0xadc
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 dc 0a 00 00       	mov    %eax,0xadc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6f0:	8b 3d dc 0a 00 00    	mov    0xadc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 739:	8b 3d dc 0a 00 00    	mov    0xadc,%edi
 ...
 762:	e8 e9 fe ff ff       	call   650 <free>
  return freep;
 767:	a1 dc 0a 00 00       	mov    0xadc,%eax
 ...
 794:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 797:	a3 dc 0a 00 00       	mov    %eax,0xadc
}
 ...
 7ae:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 dc 0a 00 00 e0 	movl   $0xae0,0xadc
 7b7:	0a 00 00 
    base.s.size = 0;
 7ba:	bf e0 0a 00 00       	mov    $0xae0,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 e0 0a 00 00 e0 	movl   $0xae0,0xae0
 7c6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7cb:	c7 05 e4 0a 00 00 00 	movl   $0x0,0xae4
 7d2:	00 00 00 
    if(p->s.size >= nunits){
