...
int main()
{
  ...
  12:	51                   	push   %ecx
    ...
    int child1 = fork();
  13:	e8 f3 02 00 00       	call   30b <fork>
    if(child1 != 0) {
  18:	85 c0                	test   %eax,%eax
  1a:	74 40                	je     5c <main+0x5c>
        printf(1, "process %d created\n", child1);
  1c:	51                   	push   %ecx
  1d:	89 c3                	mov    %eax,%ebx
  1f:	50                   	push   %eax
  20:	68 18 08 00 00       	push   $0x818
  25:	6a 01                	push   $0x1
  27:	e8 84 04 00 00       	call   4b0 <printf>
        int child2 = fork();
  2c:	e8 da 02 00 00       	call   30b <fork>
        if(child2 != 0) {
  31:	83 c4 10             	add    $0x10,%esp
  34:	85 c0                	test   %eax,%eax
  36:	74 57                	je     8f <main+0x8f>
            printf(1, "process %d created\n", child2);
  38:	52                   	push   %edx
  39:	50                   	push   %eax
  3a:	68 18 08 00 00       	push   $0x818
  3f:	6a 01                	push   $0x1
  41:	e8 6a 04 00 00       	call   4b0 <printf>
            write(1, "parent\n", 7);
  46:	83 c4 0c             	add    $0xc,%esp
  49:	6a 07                	push   $0x7
  4b:	68 2c 08 00 00       	push   $0x82c
  50:	6a 01                	push   $0x1
  52:	e8 dc 02 00 00       	call   333 <write>
  57:	83 c4 10             	add    $0x10,%esp
  5a:	eb 24                	jmp    80 <main+0x80>
  ...
  5f:	6a 64                	push   $0x64
  61:	e8 3d 03 00 00       	call   3a3 <sleep>
        write(1, "finish: child1\n", 15);
  66:	83 c4 0c             	add    $0xc,%esp
  69:	6a 0f                	push   $0xf
  6b:	68 44 08 00 00       	push   $0x844
  70:	6a 01                	push   $0x1
  72:	e8 bc 02 00 00       	call   333 <write>
  77:	83 c4 10             	add    $0x10,%esp
  7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    }

    while(wait() != -1);
  80:	e8 96 02 00 00       	call   31b <wait>
  85:	83 f8 ff             	cmp    $0xffffffff,%eax
  88:	75 f6                	jne    80 <main+0x80>
    exit();
  8a:	e8 84 02 00 00       	call   313 <exit>
            wait_for_process(child1);
  8f:	83 ec 0c             	sub    $0xc,%esp
  92:	53                   	push   %ebx
  93:	e8 33 03 00 00       	call   3cb <wait_for_process>
            write(1, "finish: child2\n",15);
  98:	83 c4 0c             	add    $0xc,%esp
  9b:	6a 0f                	push   $0xf
  9d:	68 34 08 00 00       	push   $0x834
  a2:	6a 01                	push   $0x1
  a4:	e8 8a 02 00 00       	call   333 <write>
 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 439:	0f b6 92 5c 08 00 00 	movzbl 0x85c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	eb 1a                	jmp    650 <printf+0x1a0>
          s = "(null)";
 636:	bb 54 08 00 00       	mov    $0x854,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 685:	a1 08 0b 00 00       	mov    0xb08,%eax
{
 ...
 6a6:	73 10                	jae    6b8 <free+0x38>
{
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 08 0b 00 00       	mov    %eax,0xb08
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 71d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 720:	8b 3d 08 0b 00 00    	mov    0xb08,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 769:	8b 3d 08 0b 00 00    	mov    0xb08,%edi
 ...
 792:	e8 e9 fe ff ff       	call   680 <free>
  return freep;
 797:	a1 08 0b 00 00       	mov    0xb08,%eax
 ...
 7c4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7c7:	a3 08 0b 00 00       	mov    %eax,0xb08
}
 ...
 7de:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 08 0b 00 00 0c 	movl   $0xb0c,0xb08
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf 0c 0b 00 00       	mov    $0xb0c,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 0c 0b 00 00 0c 	movl   $0xb0c,0xb0c
 7f6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7fb:	c7 05 10 0b 00 00 00 	movl   $0x0,0xb10
 802:	00 00 00 
    if(p->s.size >= nunits){
