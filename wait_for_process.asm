...
int main()
{
  ...
  38:	52                   	push   %edx
  39:	50                   	push   %eax
  3a:	68 f8 07 00 00       	push   $0x7f8
  3f:	6a 01                	push   $0x1
  41:	e8 4a 04 00 00       	call   490 <printf>
            write(1, "parent\n", 7);
  46:	83 c4 0c             	add    $0xc,%esp
  49:	6a 07                	push   $0x7
  4b:	68 0c 08 00 00       	push   $0x80c
  50:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	eb 1a                	jmp    630 <printf+0x1a0>
          s = "(null)";
 616:	bb 34 08 00 00       	mov    $0x834,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 665:	a1 e8 0a 00 00       	mov    0xae8,%eax
{
 ...
 686:	73 10                	jae    698 <free+0x38>
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	a3 e8 0a 00 00       	mov    %eax,0xae8
}
 6b7:	5e                   	pop    %esi
 6b8:	5f                   	pop    %edi
 6b9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 700:	8b 3d e8 0a 00 00    	mov    0xae8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 749:	8b 3d e8 0a 00 00    	mov    0xae8,%edi
 ...
 772:	e8 e9 fe ff ff       	call   660 <free>
  return freep;
 777:	a1 e8 0a 00 00       	mov    0xae8,%eax
 ...
 7a4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7a7:	a3 e8 0a 00 00       	mov    %eax,0xae8
}
 ...
 7be:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 e8 0a 00 00 ec 	movl   $0xaec,0xae8
 7c7:	0a 00 00 
    base.s.size = 0;
 7ca:	bf ec 0a 00 00       	mov    $0xaec,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 ec 0a 00 00 ec 	movl   $0xaec,0xaec
 7d6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7db:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 7e2:	00 00 00 
    if(p->s.size >= nunits){
