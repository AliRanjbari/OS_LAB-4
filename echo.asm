...
main(int argc, char *argv[])
{
  ...
  38:	68 e8 07 00 00       	push   $0x7e8
  3d:	83 c3 04             	add    $0x4,%ebx
  40:	50                   	push   %eax
  41:	68 ea 07 00 00       	push   $0x7ea
  46:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	eb 1a                	jmp    620 <printf+0x1a0>
          s = "(null)";
 606:	bb f1 07 00 00       	mov    $0x7f1,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 655:	a1 a8 0a 00 00       	mov    0xaa8,%eax
{
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 a8 0a 00 00       	mov    %eax,0xaa8
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6f0:	8b 3d a8 0a 00 00    	mov    0xaa8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 739:	8b 3d a8 0a 00 00    	mov    0xaa8,%edi
 ...
 762:	e8 e9 fe ff ff       	call   650 <free>
  return freep;
 767:	a1 a8 0a 00 00       	mov    0xaa8,%eax
 ...
 7ae:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 a8 0a 00 00 ac 	movl   $0xaac,0xaa8
 7b7:	0a 00 00 
    base.s.size = 0;
 7ba:	bf ac 0a 00 00       	mov    $0xaac,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 ac 0a 00 00 ac 	movl   $0xaac,0xaac
 7c6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7cb:	c7 05 b0 0a 00 00 00 	movl   $0x0,0xab0
 7d2:	00 00 00 
    if(p->s.size >= nunits){
